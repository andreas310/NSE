...
public class DataaktaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.click).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DataaktaActivity.this);
                builder.setTitle("Masukan nama Pihak 1");
                builder.setMessage("Jika ingin menampilkan semua, input di kosongi saja");

                // Set up the input
                final EditText input = new EditText(DataaktaActivity.this);
