...
public class NotariilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.click).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DatePickerDialog dp = new DatePickerDialog(NotariilActivity.this,
                ...
                dp.setTitle("Notariil");
                dp.setMessage("Pilih bulan dan tahun akta yang dicari");
